    ...
    'f': (function () {
      return {
        ...
        init: function () {
          ...
          $.v.endpoint = {
            'pinterest': 'https://' + map.domain + '.pinterest.com', //added https: ***
            'repin': 'https://' + map.domain + '.pinterest.com/pin/%s/repin/x/', //added https: ***
            'create': 'https://' + map.domain + '.pinterest.com/pin/create/button/?' //added https: ***
          }
